...
#acquire data
ppi_a = pandas.read_table("Raw/HI-union.tsv")
dpi_a = pandas.read_table("Raw/dpi_preprocessed.tsv", dtype=np.unicode_)
dsa_aaa = pandas.read_table("Raw/meddra_all_se.tsv")
