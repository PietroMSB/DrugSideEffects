...
tr_graph = CompositeGraphObject(arcs, nodes, targets, type_mask, LABEL_DIM, 'n', tr_mask, output_mask, aggregation_mode=AGGREGATION)
va_graph = CompositeGraphObject(arcs, nodes, targets, type_mask, LABEL_DIM, 'n', va_mask, output_mask, aggregation_mode=AGGREGATION)
te_graph = CompositeGraphObject(arcs, nodes, targets, type_mask, LABEL_DIM, 'n', te_mask, output_mask, aggregation_mode=AGGREGATION)
